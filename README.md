...
- In order to get a copy of this project you need to clone the repo
  git clone https://github.com/Profsain/spendtrac-app.git
- cd spendtrac
### Install
...
- Spend and income statistics
## 🤝 Contributing

Contributions, issues, and feature requests are welcome!

Feel free to check the [issues page](https://github.com/Profsain/spendtrac-app/issues/).
